...
| 0.4.0 | Section 3: beat detection, MIDI clock, seeds, morphing, video recording | In progress on `release/0.3.0` (branch to rename or split at tag time); beat detection, MIDI clock, seeds done |
