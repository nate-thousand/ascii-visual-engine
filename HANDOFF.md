...
- `release/0.3.0` branches from it and carries the 0.3.0 API work; `package.json` says 0.3.0. Done so far: `createEngine()` facade, nested presets (with flat normalization and a fixture backed compatibility test), HiDPI.
...
3. Continue 0.3.0 from `ROADMAP.md` section 2 in order: `PointerInput`, frame budget in BENCHMARKS.md, engine state, preset loader and export, params, effect tests.
